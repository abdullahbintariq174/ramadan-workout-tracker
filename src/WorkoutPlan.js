const WorkoutPlan = {
  warmup: {
    ...
    icon: "fire-alt",
    exercises: [
      { name: "Arm Circles", icon: "sync-alt", duration: 30 },
      { name: "Shoulder Rolls", icon: "sync-alt", duration: 30 },
      { name: "March in Place", icon: "walking", duration: 30 },
      { name: "Side Lunges", icon: "arrows-alt-h", duration: 30 },
      { name: "Neck & Wrist Rolls", icon: "sync-alt", duration: 30 },
    ...
    rounds: [
      {
        ...
        exercises: [
          ...
          { name: "Lunges", icon: "shoe-prints", workDuration: 40, restDuration: 20 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: "Plank", icon: "hands", workDuration: 40, restDuration: 20 },
          ...
          { name: "Shoulder Taps", icon: "hand-point-up", workDuration: 40, restDuration: 20 }
        ]
      },
      {
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: "Russian Twists", icon: "sync-alt", workDuration: 40, restDuration: 20 },
          { name: "Plank", icon: "hands", workDuration: 40, restDuration: 20 },
  ...
  cooldown: {
    ...
    exercises: [
      ...
      { name: "Neck Stretch", icon: "head-side", duration: 30 }
    ]
  }
};
